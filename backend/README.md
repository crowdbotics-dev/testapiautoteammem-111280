...
## Project Structure
    ...
    ├── testapiautoteammem_111280  # Django project configurations
...
1. Clone this repo and `cd testapiautoteammem_111280`
...
2. Clone this repo and `cd testapiautoteammem_111280`
